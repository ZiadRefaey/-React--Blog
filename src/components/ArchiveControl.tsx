export default function ArchiveControl({
  ...
  return (
    <div className="bg-card-background p-4 rounded-xl w-full">
      ...
      <button
        type="submit"
        className="p-4 mt-4 bg-primary font-semibold text-background flex items-center justify-center gap-2 w-full rounded-xl cursor-pointer hover:bg-secondary transition"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
